...
#define GATOR_KERNEL_UNWINDING_USE_WALK_STACKFRAME
#endif

#if !defined(GATOR_KERNEL_UNWINDING_USE_WALK_STACKFRAME) && !defined(CONFIG_STACKTRACE)
...
#ifdef GATOR_KERNEL_UNWINDING

#include <asm/stacktrace.h>
#ifndef GATOR_KERNEL_UNWINDING_USE_WALK_STACKFRAME
...
#ifdef GATOR_KERNEL_UNWINDING_USE_WALK_STACKFRAME
